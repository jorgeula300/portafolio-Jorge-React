...
const ContactoModal = () => {
    ...
    return (
        <div className="fixed top-0 left-0 w-full min-h-[100vh] z-50 bg-[#0003] backdrop-blur-[2px] flex justify-center items-center transition-transform animate-fade animate-once animate-duration-1000">
            <form
