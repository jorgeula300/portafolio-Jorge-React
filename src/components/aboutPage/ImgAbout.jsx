...
const ImgAbout = () => {
    return (
        <div className=' flex justify-center items-center w-full px-2'>
            ...
            <div className=' w-full max-w-[500px] h-full p-2 max-h-[300px] bg-white rounded-full flex justify-center items-center bg-gradient-to-t from-[#ffffffa5] to-[#4BDB9E] '>
