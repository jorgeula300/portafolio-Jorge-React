...
const ModalPortafolio = ({ datosPotafolio }) => {
    ...
    return (
        <div className=" fixed top-0 left-0 w-full min-h-[100vh] bg-[#0003] backdrop-blur-[2px] flex justify-center items-center transition-transform px-2">
            <div className=" text-white w-full max-w-[500px] bg-[#06121A] border m-auto absolute  rounded-xl space-y-3 pb-4">
                ...
                <div className=" w-full  grid grid-cols-4 justify-items-center">
                    {
                        datosPotafolio.skills.map(skill =>
                            <div className=" w-full flex flex-col justify-center items-center">
                                <h2>{skill.name}</h2>
                                <img className="w-[20px]" src={skill.img} alt="" />
