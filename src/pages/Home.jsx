...
const Home = () => {
    ...
    return (<>
        <div className=" flex flex-col justify-center items-center dark:text-white w-full min-h-[100vh] ">
            <div className="w-full h-[52px] absolute top-0 " id="home">

            </div>
            <div className="grid  md:grid-cols-2 md:justify-items-center w-full">
                <div className=" flex justify-center items-center px-3 md:px-5">
                    <div className="w-full max-w-[400px] xl:max-w-[500px] md:min-h-[20vh] space-y-3 animate-fade-right animate-once animate-duration-1000">
                        ...
                        <div className=" flex items-center space-x-3">
                            <a href="/CV.pdf" download className="border-solid bg-[#78AB92] text-slate-200 hover:bg-[#4BDB9E]  px-2 py-1 rounded-lg font-medium text-sm xl:text-lg">Descargar cv</a>
        ...
        <div className=" w-full min-h-[100vh] bg-[#F1F6F3] dark:bg-[#06121A] flex flex-col justify-center relative">
            <div className="w-full h-[52px] absolute top-0 " id="about">
        ...
        <div className=' w-full  min-h-[100vh] py-3 flex flex-col justify-center items-center dark:text-white bg-[#F1F6F3] dark:bg-[#091922] space-y-5 animate-fade-up animate-once animate-duration-1000 relative'>
            <div className="w-full h-[52px] absolute top-0 " id="skills">
        ...
        <div className=" w-full h-full flex flex-col justify-center items-center gap-5 px-2 animate-fade animate-once animate-duration-1000 bg-[#F1F6F3] dark:bg-[#06121A] relative" >
            <div className="w-full h-[52px] absolute top-0 " id="porfolio">

            </div>
            <h2 className=" text-center dark:text-white text-xl sm:text-2xl md:text-3xl  font-bold mt-14">MIS <span className=" text-[#78AB92] dark:text-[#4BDB9E]">PROYECTOS</span></h2>
