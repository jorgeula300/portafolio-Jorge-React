...
const Home = () => {
    ...
    return (<div className=" grid  md:grid-cols-2 md:justify-items-center dark:text-white w-full min-h-[89vh] ">
        ...
        <div className="flex justify-center items-center px-3 md:px-5 ">
            <div className=" rounded-full  w-[260px] h-[260px] md:w-[300px] md:h-[300px] xl:w-[400px] xl:h-[400px] flex justify-center items-center  border-2 border-slate-400  bg-gradient-to-t from-[#ffffffa5] to-[#4BDB9E] overflow-hidden">
